Pod::Spec.new do |s|
  s.name         = "latest-TCPrivacy-Release-Bitcode-noIDFA"
  s.version      = "4.6.5"
  ...
  s.description  = <<-DESC
           Go to https://github.com/TagCommander/pods/tree/master/TCPrivacy for more details
                   DESC
  s.platform     = :ios, '8.0'
  s.source   = { :http => "https://github.com/TagCommander/pods/raw/master/TCPrivacy/4/6/5/Release/TCPrivacy-Bitcode-noIDFA.zip" }
