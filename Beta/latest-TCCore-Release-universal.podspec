Pod::Spec.new do |s|
  s.name         = "latest-TCCore-Release-universal"
  s.version      = "4.2.1"
  s.homepage     = "https://github.com/TagCommander/pods/tree/master/Beta"
  ...
  s.description  = <<-DESC
           Go to https://github.com/TagCommander/pods/tree/master/TCCore for more details
                   DESC
  s.platform     = :ios, '8.0'
  s.source   = { :http => "https://github.com/TagCommander/pods/raw/master/Beta/Core_4.2.1.zip" }
