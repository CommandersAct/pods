Pod::Spec.new do |s|
  s.name         = "latest-TCCore-Release-universal-Bitcode-noIDFA-noIAB"
  s.version      = "4.6.5"
  ...
  s.description  = <<-DESC
           Go to https://github.com/TagCommander/pods/tree/master/TCCore for more details
                   DESC
  s.platform     = :ios, '8.0'
  s.source   = { :http => "https://github.com/TagCommander/pods/raw/master/TCCore/4/6/5/Release-universal/TCCore-Bitcode-noIDFA-noIAB.zip" }
