Pod::Spec.new do |s|
  s.name         = "latest-TCPartners-Release-universal-noIDFA-noIAB"
  s.version      = "4.5.8"
  ...
  s.description  = <<-DESC
           Go to https://github.com/TagCommander/pods/tree/master/TCPartners for more details
                   DESC
  s.platform     = :ios, '8.0'
  s.source   = { :http => "https://github.com/TagCommander/pods/raw/master/TCPartners/4/5/8/Release-universal/TCPartners-noIDFA-noIAB.zip" }
