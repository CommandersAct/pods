Pod::Spec.new do |s|
  s.name         = "latest-TCSegment-Release-Bitcode-noIAB"
  s.version      = "4.3.0"
  ...
  s.description  = <<-DESC
           Go to https://github.com/TagCommander/pods/tree/master/TCSegment for more details
                   DESC
  s.platform     = :ios, '8.0'
  s.source   = { :http => "https://github.com/TagCommander/pods/raw/master/TCSegment/4/3/0/Release/TCSegment-Bitcode-noIAB.zip" }
