Pod::Spec.new do |s|
  s.name         = "latest-TCSDK-Release-iphoneos-Bitcode-noIDFA-noIAB"
  s.version      = "4.5.3"
  ...
  s.description  = <<-DESC
           Go to https://github.com/TagCommander/pods/tree/master/TCSDK for more details
                   DESC
  s.platform     = :ios, '8.0'
  s.source   = { :http => "https://github.com/TagCommander/pods/raw/master/TCSDK/4/5/3/Release-iphoneos/TCSDK-Bitcode-noIDFA-noIAB.zip" }
