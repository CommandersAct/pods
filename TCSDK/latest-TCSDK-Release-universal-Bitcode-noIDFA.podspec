Pod::Spec.new do |s|
  s.name         = "latest-TCSDK-Release-universal-Bitcode-noIDFA"
  s.version      = "4.5.1"
  ...
  s.description  = <<-DESC
           Go to https://github.com/TagCommander/pods/tree/master/TCSDK for more details
                   DESC
  s.platform     = :ios, '8.0'
  s.source   = { :http => "https://github.com/TagCommander/pods/raw/master/TCSDK/4/5/1/Release-universal/TCSDK-Bitcode-noIDFA.zip" }
