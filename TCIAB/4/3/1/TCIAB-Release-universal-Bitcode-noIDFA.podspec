Pod::Spec.new do |s|
  s.name         = "TCIAB-Release-universal-Bitcode-noIDFA"
  s.version      = "4.3.1"
  ...
  s.description  = <<-DESC
           Go to https://github.com/TagCommander/pods/tree/master/TCIAB for more details
                   DESC
  s.platform     = :ios, '8.0'
  s.source   = { :http => "https://github.com/TagCommander/pods/raw/master/TCIAB/4/3/1/Release-universal/TCIAB-Bitcode-noIDFA.zip" }
