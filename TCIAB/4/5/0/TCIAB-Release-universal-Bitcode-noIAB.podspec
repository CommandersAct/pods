Pod::Spec.new do |s|
  s.name         = "TCIAB-Release-universal-Bitcode-noIAB"
  s.version      = "4.5.0"
  ...
  s.description  = <<-DESC
           Go to https://github.com/TagCommander/pods/tree/master/TCIAB for more details
                   DESC
  s.platform     = :ios, '8.0'
  s.source   = { :http => "https://github.com/TagCommander/pods/raw/master/TCIAB/4/5/0/Release-universal/TCIAB-Bitcode-noIAB.zip" }
