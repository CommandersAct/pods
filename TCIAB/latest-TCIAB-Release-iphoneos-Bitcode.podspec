Pod::Spec.new do |s|
  s.name         = "latest-TCIAB-Release-iphoneos-Bitcode"
  s.version      = "4.3.2"
  ...
  s.description  = <<-DESC
           Go to https://github.com/TagCommander/pods/tree/master/TCIAB for more details
                   DESC
  s.platform     = :ios, '8.0'
  s.source   = { :http => "https://github.com/TagCommander/pods/raw/master/TCIAB/4/3/2/Release-iphoneos/TCIAB-Bitcode.zip" }
